...
//        [self removeAllScanFoundDevice];
    ...
    switch (central.state) {
        ...
        {
//            [UIAlertController jk_DoubleButtonAlertWithTitle:@"开启蓝牙" message:@"连接“知心”心电贴需要开启蓝牙，您是否允许？" cancelText:@"禁止" confirmText:@"允许" cancel:^{
//
//            } confirm:^{
//                [NSObject jumpSetingPage:@"App-Prefs:root=Bluetooth"];
...
//    existedP.errorDescription = error ;
    ...
    if (existedP) {
     ...
     [[NSNotificationCenter defaultCenter] postNotificationName:@"connetstatusDevice" object:existedP];
}
